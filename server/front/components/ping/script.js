...
async function Ping() {
  ...
  document.getElementById("description").textContent = `In local game ${user_name.toUpperCase()} moves using the keys W and S And the opponent uses the arrow keys (Up and Down); While in the remote game they uses the arrow keys (Left and Right).`
